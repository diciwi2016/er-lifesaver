...
x=0
for i in res:
     print i['name'], "<br>", i['formatted_address'], "<BR>", '<img src="', i['icon'], '>"<br><br><br>'
     x+=1
     if x== 5:
        break
#   if loc == 'brooklyn' or loc == 'Brooklyn':
  #      if int(i['formatted_address'][-20:-15]) in bklyn_zip:
   #         print i['name'], "<br>", i['formatted_address'], "<BR>", '<img src="', i['icon'], '>"<br><br><br>'
 #   elif loc == 'queens' or loc == 'Queens':
  #      if int(i['formatted_address'][-20:-15]) in queens_zip:
   #         print i['name'], "<br>", i['formatted_address'], "<BR>", '<img src="', i['icon'], '>"<br><br><br>'
    #elif loc == 'bronx' or loc == 'Bronx':
     #   if int(i['formatted_address'][-20:-15]) in bronx_zip:
      #      print i['name'], "<br>", i['formatted_address'], "<BR>", '<img src="', i['icon'], '>"<br><br><br>'
#    elif loc == 'manhattan' or loc == 'Manhattan':
 #       if int(i['formatted_address'][-20:-15]) in manh_zip:
  #          print i['name'], "<br>", i['formatted_address'], "<BR>", '<img src="', i['icon'], '>"<br><br><br>'
   # elif loc == 'staten+island' or loc == 'Staten+Island':
    #    if int(i['formatted_address'][-20:-15]) in bklyn_zip:
     #       print i['name'], "<br>", i['formatted_address'], "<BR>", '<img src="', i['icon'], '>"<br><br><br>'
#    else:
 #       print "No results"
